...
def verificar_cpf(cpf):
    ...
    if len(cpf) != 11 or not cpf.isdigit():
        return False # Retorna False se o CPF não tiver 11 dígitos ou se conter caracteres não numéricos
    ...
    return cpf == cpf_calculado # Retorna True se o CPF original for igual ao CPF calculado com dígitos verificadores
